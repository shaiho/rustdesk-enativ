...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable IPv6 P2P connection", "אפשר חיבור P2P דרך IPv6"),
        ...
        ("Scale custom", "קנה מידה מותאם"),
        ("Custom scale slider", "מחוון קנה מידה מותאם"),
        ("Decrease", "הקטן"),
        ("Increase", "הגדל"),
        ...
        ("Allow insecure TLS fallback", "אפשר נפילה ל־TLS לא מאובטח"),
        ("allow-insecure-tls-fallback-tip", "מאפשר חיבור עם TLS לא מאובטח במקרה של בעיות תאימות (פחות מומלץ)."),
        ("Disable UDP", "כבה UDP"),
        ("disable-udp-tip", "כיבוי UDP עשוי לשפר תאימות ברשתות מסוימות, אך עלול להפחית ביצועים."),
        ("server-oss-not-support-tip", "השרת אינו תומך בתכונה זו בגרסת הקוד הפתוח (OSS)."),
        ("input note here", "הקלד כאן הערה"),
        ("note-at-conn-end-tip", "הערה זו תוצג בסיום ההתחברות"),
